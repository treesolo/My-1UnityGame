...
public class EnemyExpert : MonoBehaviour
{
    public float speed = 3.0f;
    private Rigidbody enemyRb;
    private GameObject player;
    public float blastStrength = 13.0f;
    private float afterShockStrength = 13.0f;
    ...
    void Start()
    {
        ...
        rendHard.material.color = Color.yellow;
